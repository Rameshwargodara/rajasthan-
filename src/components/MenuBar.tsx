...
export const MenuBar: React.FC = () => {
  ...
  return (
    <div
      id="windows-menubar"
      className="bg-slate-50 border-b border-slate-200 select-none flex items-center px-1.5 h-6 text-xs text-slate-800 relative z-30 font-sans"
    >
